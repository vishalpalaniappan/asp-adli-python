...
To address the limitations of traditional approaches to understanding software systems, this document presents an approach that automatically interprets execution through a faithful representation of the design’s behavior. Because execution is understood through the behavior of the design, this approach has several direct implications:
